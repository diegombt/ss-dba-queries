...
------------------------------------------------------------------------------------------------------------
-- JOB schedules and frequency
-- https://blog.sqlauthority.com/2020/01/31/sql-server-details-about-sql-jobs-and-job-schedules/
------------------------------------------------------------------------------------------------------------
...
SELECT
  J.[name] AS JobName, J.[enabled] AS JobIsEnabled, ISNULL(JS.[enabled], 0) AS ScheduleIsEnabled
